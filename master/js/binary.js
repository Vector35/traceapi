...
function update_binary_info() {
	$("#bin-num").html("Binary " + active_bsid.toString());
...
function request_pov_result(povid) {
	...
	$.ajax({
		url: key + "pov/" + povid.toString() + "/result/" + active_bsid.toString() + "/replay",
		success: function (data) {
			$.ajax({
...
function request_poll_result(pollid) {
	...
	$.ajax({
		url: key + "poll/" + pollid.toString() + "/result/" + active_bsid.toString() + "/replay",
		success: function (data) {
			$.ajax({
				url: key + "exec/" + data['execution'].toString() + "/perf",
				success: function (perf) {
